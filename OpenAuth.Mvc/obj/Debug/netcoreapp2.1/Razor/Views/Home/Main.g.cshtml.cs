#pragma checksum "E:\学习备份\OpenAuth.Core\OpenAuth.Mvc\Views\Home\Main.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5738d987d8485310fe175c3b3e5be8c1d9b279c3"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5738d987d8485310fe175c3b3e5be8c1d9b279c3", @"/Views/Home/Main.cshtml")]
...
<blockquote class=""layui-elem-quote explain"">
    ...
    <p>
        系统默认System账号登录，可以查看所有权限，如果用其他账号（如：admin/test）可以查看相应的授权情况。
        数据库密码明文存储，不要问为什么不加密，因为你要问这些账号的密码我也记不住啊O(∩_∩)O
    </p>
    <p>
        <span style=""color: #1E9FFF;"">郑重提示：为安全起见，关闭了所有修改请求，如想体验完整功能可搭建本地环境，并将appsettings.json中的version置为空字符串</span>
    </p>
    <p>
        <a href=""https://gitee.com/yubaolee/OpenAuth.Core"" target=""_blank"" class=""layui-btn layui-btn-xs layui-btn-danger"">项目地址</a>
        <a class=""layui-btn layui-btn-xs"" target=""_blank"" href=""h");
            WriteLiteral(@"ttp://doc.openauth.me"">在线文档</a>
...
<div class=""row"">
    <div class=""sysNotice col"">
        ...
        <div class=""layui-elem-quote layui-quote-nm"">
            <h3># core 1.0 - 2018.12</h3>
            <p>* 全面支持mysql</p>
            <p>* 全面支持.net core 2.1</p>
        </div>
        <div class=""layui-elem-quote layui-quote-nm"">
            <h3># v4.0（颠覆） - 2018</h3>
            <p>* 引入最新版layui，这是有史以来最酷的Openauth.net</p>
            <p>* 全面优化数据结构</p>
            <p>* 全面优化流程引擎</p>
        </div>
    </div>
